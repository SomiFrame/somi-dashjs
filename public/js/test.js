...
var BufferController = function () {
    function BufferController(isoFile) {
    ...
    _createClass(BufferController, [{
        key: "calculateSegmentIndexForTime",
        value: function calculateSegmentIndexForTime(time) {
            var VcalculateTime = void 0,
                Vtimescale = void 0,
                SegmentIndex = void 0;
            Vtimescale = this.VideoBox.timescale;
            VcalculateTime = 0;
            for (var i = 0, length = this.VideoBox.references.length; i < length; i++) {
        ...
        key: "calculateRequestRangeForIndex",
        value: function calculateRequestRangeForIndex(initRange, SegmentIndex) {
...
var MediaSourceE = function () {
    function MediaSourceE(selectorString, url, mimeType, initRange, indexRange) {
        _classCallCheck(this, MediaSourceE);

        if (!MediaSourceE.isSupportDash()) {
            throw new Error('Oops! your browser does not support MediaSource extension');
        }
        this.manifest = new _Manifest2.default(selectorString, url, mimeType, initRange, indexRange);
        this.bufferController = null;
        this.bufferCache = new _BufferCache2.default();
    ...
    _createClass(MediaSourceE, [{
        ...
        key: 'onVideoSeeked',
        value: function onVideoSeeked(e) {}
    }, {
        key: 'onVideoSeeking',
        value: function onVideoSeeking(e) {}
    }, {
        key: 'onVideoTimeUpdate',
        value: function onVideoTimeUpdate() {
            this.bufferController.CurrentSegmentIndex = this.bufferController.calculateSegmentIndexForTime(this.manifest.videoDom.currentTime);
        ...
        key: 'loadCurrentSegmentData',
        value: function loadCurrentSegmentData(index) {
            var loadIndex = index;
        ...
        key: 'loadNextSegmentData',
        value: function loadNextSegmentData(index) {
            var loadIndex = index;
        ...
        key: 'detectivePreloadOrNot',
        value: function detectivePreloadOrNot() {
            var currentIndex = this.bufferController.CurrentSegmentIndex;
            var lastLoadedIndex = this.bufferController.LastLoadedSegmentIndex;
            var preLoadNumber = this.bufferController.PreSegmentNumber;
        ...
        value: function loadSegmentDataFromCache(index) {
            ...
            if (this.detectivePreloadOrNot()) {
                var NextIndex = this.bufferController.NextSegmentIndex;
        ...
        value: function loadSegmentDataFromNet(index) {
            ...
            var loadIndex = index;
            var url = this.manifest.SegmentUrl;
            var range = this.bufferController.calculateRequestRangeForIndex(this.manifest.SegmentSIDX.IndexRange, loadIndex);
            var option = {
                method: 'GET',
                headers: {
        ...
        key: 'pushIndexToQueue',
        value: function pushIndexToQueue(index) {
            var array = this.bufferController.QueueLoadEvent;
        ...
        key: 'getUrlFromMSE',
        value: function getUrlFromMSE() {
            return window.URL.createObjectURL(this.mediasource);
        }
    }], [{
        key: 'isSupportDash',
        value: function isSupportDash() {
...
var _MediaSourceE = require('../src/MediaSourceE');

var _MediaSourceE2 = _interopRequireDefault(_MediaSourceE);
